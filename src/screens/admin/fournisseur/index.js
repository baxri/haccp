...
export class AdminFournisseurIndexScreen extends React.Component {
        ...
        return (
            <Container>
                                ...
                                <Right>
                                    <View style={{ flexDirection: 'row', flex: 1, margin: 0, width: 250, }}>
                                        <Button style={{ flex: 0.5, height: 65, borderLeftWidth: 0, }} full light
                                            onPress={() => this.props.navigation.navigate('AdminFournisseurItem', data)}>
                ...
                <Fab
                    ...
                    onPress={() => this.props.navigation.navigate('AdminFournisseurItem', {
                        id: "",
                        name: "",
                    })}>
